function DashboardBox({ head, body, icon, val }) {
  const xml = (
    <div className="w-[clamp(5rem,17.36111111111111vw,25rem)] min-h-[111px] rounded-[17.096px] bg-white box-shadow pl-[2.45rem] pt-[3.2rem] blur-out max-md:w-[20rem] max-md:max-w-[unset] max-md:shrink-0 !max-md:shadow-[0px_1px_5px_rgba(0,0,0,0.1)] max-[1281px]:pl-[1.5rem] max-[1281px]:pt-0 max-[1281px]:max-w-[25%] max-[1281px]:flex max-[1281px]:flex-col max-[1281px]:justify-center">
      <div
