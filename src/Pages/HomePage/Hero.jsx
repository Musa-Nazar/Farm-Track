...
function Hero() {
  const xml = (
    <section className="w-full h-[65.8rem] hero flex">
      <div className="flex flex-col gap-[5rem] mr-auto mt-[9.9rem] ml-[clamp(2rem,6.666666667vw,9.6rem)] items-start">
        <h1 className="text-[#fff] text-[7.2rem] font-[500] leading-[143.836%] max-md:text-[3.5rem]">
          Manage Your Poultry and Fish <br />
          Inventory with Ease
        </h1>
        <p className="text-[#fff] poppins text-[2.1rem] font-[400] tracking-[0.042rem] leading-[200%] max-md:text-[1.6rem]">
