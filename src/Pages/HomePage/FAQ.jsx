...
function FAQ() {
  const xml = (
    <div className="bg-[#F4F4F4] flex flex-col pb-[6.5rem] max-md:pb-[5.659rem] max-md:px-[1.6rem] ">
      ...
      <div className="flex flex-col gap-[3.9rem] max-md:gap-[1.6rem] w-[128rem] max-w-[85%] mx-auto">
