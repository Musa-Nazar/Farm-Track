...
function SalesChartsContainer() {
  ...
  const xml = (
    <div className="flex ml-[3.8rem] mr-[9.6rem] mt-[2.5rem] justify-between gap-[1rem] !bg-transparent max-md:flex-col max-md:mx-[3.1rem] max-md:gap-[2.5rem] mb-[2rem]">
      <SalesAndExpenseContainer cs="!ml-0 !mr-0 w-[60%] flex-none max-md:w-full relative before:absolute before:content-[''] before:w-full before:h-full before:bg-[rgba(0,0,0,0.2)] before:left-0 before:top-0 before:z-[100] before:rounded-[15px]">
        <SalesOverallChart />
