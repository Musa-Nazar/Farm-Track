...
function Footer() {
  const xml = 
  <footer className="flex-col bg-[#033D036B] px-[clamp(2rem,8.333333333vw,12rem)] pt-[8.6rem] w-full h-[55.1rem] relative">
    <div className="flex items-start justify-between gap-[19.95rem] w-full">
      <div className="flex flex-col  items-start">
        ...
        <p className="w-[26.904rem] min-h-[9rem] manrope text-[#020202] text-[1.5rem] font-[500] leading-[200%] ml-[4.25rem]">Innovating Agriculture for a Better Tomorrow. Smart Farming, Smart Future."</p>
      </div>
    ...
    <div className="w-full h-[7rem] bg-[#1F1F1F] absolute bottom-0 left-0">
      <div className='flex items-center h-full pr-[4.5rem] justify-end gap-[1.6rem]'>
