...
function InventoryErrorUI({ message }) {
  const xml = (
    <div className="flex flex-col mx-[2.8rem] bg-[#FFF] rounded-[1.5rem] min-h-[89.3dvh]">
      <>
          ...
          <div className="relative flex justify-center items-center mt-[0.4rem]">
            ...
            >
              <img
                src={search}
                alt="err"
                className="w-[2.4rem] aspect-square"
              />
        ...
        <p className="my-[1rem] poppins text-[2rem] text-center py-[1rem] text-red-500">
          {message}
        </p>
      </>
    </div>
...
export default InventoryErrorUI;
